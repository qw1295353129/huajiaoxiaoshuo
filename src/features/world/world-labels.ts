...
export const INPUT_CLASS =
  "w-full rounded-lg border border-black/10 bg-white/70 px-2.5 py-1.5 text-sm outline-none transition placeholder:opacity-40 focus:border-black/40 dark:border-white/10 dark:bg-white/5";
